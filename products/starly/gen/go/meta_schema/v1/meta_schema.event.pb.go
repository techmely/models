...
var file_meta_schema_v1_meta_schema_event_proto_goTypes = []any{
...
func file_meta_schema_v1_meta_schema_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_meta_schema_v1_meta_schema_event_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_meta_schema_v1_meta_schema_event_proto_msgTypes[1].Exporter = func(v any, i int) any {
